...
public class Pymk1 {
    ...
    public static class AllPairsMapper extends Mapper<Object, Text, IntWritable, IntWritable> {
        ...
        public void map(Object key, Text values, Context context) throws IOException, InterruptedException {
            ...
            IntWritable firstUser = new IntWritable(Integer.parseInt(st.nextToken()));
            ...
            while (st.hasMoreTokens()) {
                IntWritable followed = new IntWritable(Integer.parseInt(st.nextToken()));
                //friend1.set(-friend);
                context.write(followed, firstUser);
